...
var config = {
  host: "xxxxxxxxxxxxxxxxxxxxxxxxx", // give your FTP host name
  user: "xxxxxxxxxxxxxxxxxxxxxxxxx", // give your FTP username
  password: "xxxxxxxxxxxxxxxxxxxxxxx", // give your FTP password
...
async function deploy() {
  ...
  try {
    ...
    console.log(
      "\x1b[33mThank you for purchasing the E-Restro Multi-Vendor Web App! 🎉 🛍️   We appreciate your support! Happy selling! 💻 🚀\x1b[0m"
    );
  } catch (err) {
